...
\begin {figure}[h!]
\centerline{\includegraphics[width = 6cm]{imagen/circunferencia2.jpeg}}
...
\begin {figure}[h!]
\centerline{\includegraphics[width = 6cm]{imagen/Circulo, Circunferencia.png}}
...
\begin {figure}[h!]
\centerline{\includegraphics[width = 8cm]{imagen/Corrida1_circunferencia.png}}
\caption{Corrida 1}
\label{fig}
\end {figure}

\begin {figure}[h!]
\centerline{\includegraphics[width = 8cm]{imagen/Corrida2_circunferencia.png}}
\caption{Corrida 2}
\label{fig}
\end {figure}

\begin {figure}[h!]
\centerline{\includegraphics[width = 8cm]{imagen/Corrida3_circunferencia.png}}
\caption{Corrida 3}
\label{fig}
\end {figure}