...
\begin {figure}[h!]
\centerline{\includegraphics[width = 4cm]{Latex-imágenes/booleanas.png}}
...
\begin {figure}[h!]
\centerline{\includegraphics[width = 9.5cm]{Latex-imágenes/tabla de verdad de 2 datos.png}}
\caption{Corrida 3}
\label{fig}
\end {figure}

\begin {figure}[h!]
\centerline{\includegraphics[width = 9.5cm]{Latex-imágenes/tabla de verdad de 3 datos.png}}
\caption{Corrida 3}
\label{fig}
\end {figure}